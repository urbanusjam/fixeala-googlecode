...
<!--   	<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&language=es-AR&libraries=places"></script> -->
<!--   	<script type="text/javascript" -->
<!--       src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBEwuzRfGdeWo0oJlx6KZ4VRORgYVf0tvg&sensor=false&language=es-AR&libraries=places"> -->
<!-- 	</script> -->
...
// 			 	    			 }
            ...
            $('#btnIssueSubmit').click(function() {
            	...
            	if ($("#issueStep3").css("display") == 'block'){
                	...
                	if (confirm('¿Confirma que desea registrar su reclamo?')) {
	            		$.ajax({
			            		url: "http://localhost:8080/fixeala/reportIssue.html",
						 		type: "POST",
						        data: $issueForm.serialize(),     
						        ...
						        success: function(alertStatus){
						 	    				...
						 	    				if(alertStatus.result){	
						 	    					...
						 	    					bootbox.alert("¡Felicitaciones! Su reclamo ha sido registrado.");
