...
// 					}, "La contraseÃ±a no cumple con el formato requerido.");
...
//			  			{
//			  			 		required: function(){
//			  			 		  showAlert("Debe ingresar una direcciÃ³n de correo.", "alert-error");	        		  
//			  			 		}		 	
//			  		 	}
//			  		 
//			  	},
	...
	function doResetPasswordAjaxPost(){
		 ...
		 if(passwordConfirmation != password){
			 alert("La clave y la confirmaciÃ³n deben coincidir.");
		 }
		 else{
