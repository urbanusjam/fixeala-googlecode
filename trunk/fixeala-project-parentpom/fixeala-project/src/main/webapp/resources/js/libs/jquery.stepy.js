...
;(function($) {
  ...
  var methods = {
    init: function(settings) {
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: '#', 'class': 'btn btn-primary button-back', html: self.opt.backLabel };

      $('<button />', attributes).on('click.stepy', function(e) {
        e.preventDefault();
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: '#', 'class': 'btn btn-primary button-next', html: self.opt.nextLabel };
