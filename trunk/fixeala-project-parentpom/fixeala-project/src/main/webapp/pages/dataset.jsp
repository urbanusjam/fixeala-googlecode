<div id="content">
    <div class="page-header">
   	...
   	<p>
   	FIXEALA pone a disposici&oacute;n de los ciudadanos el conjunto completo de datos referentes a los reclamos barriales comprendidos 
   	...
   	dentro del marco de las pol&iacute;ticas de Gobierno Abierto. Estos cat&aacute;logos podr&aacute;n ser descargados en diversos formatos (.xls, .csv, .xml, .json) para su libre uso.
   	</p>
