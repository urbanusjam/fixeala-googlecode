...
CREATE TABLE ISSUE (
	   ...
	   ID_REPORTER VARCHAR(50) NOT NULL,
	   ID_ASSIGNED_OFFICIAL VARCHAR(50) NULL,
	   ID_AREA BIGINT(20) NULL,
	   ...
	   FOREIGN KEY (ID_REPORTER) REFERENCES USER (USERNAME),
	   FOREIGN KEY (ID_ASSIGNED_OFFICIAL) REFERENCES USER (USERNAME),
	   FOREIGN KEY (ID_AREA) REFERENCES AREA (ID_AREA)
