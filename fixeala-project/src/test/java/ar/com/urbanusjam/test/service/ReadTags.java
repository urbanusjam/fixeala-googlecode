...
//		    Scanner inFile1 = new Scanner(new File("/Users/cora/Documents/fixeala.tags.txt")).useDelimiter("\n *");
		    Scanner inFile1 = new Scanner(new File("D:/fixeala.tags.agrupados.txt")).useDelimiter("\n *");
		    ...
		    PrintStream out = new PrintStream(new FileOutputStream("D:\\fixeala.tags.agrupados.sql"));
