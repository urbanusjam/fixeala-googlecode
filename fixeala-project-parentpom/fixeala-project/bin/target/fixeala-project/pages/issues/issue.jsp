<div id="content">	
	...
	<div class="container-fluid">
        ...
        <h3 style="display:inline">Bache gigante en la esquina de mi casa &nbsp;&nbsp;<i class="icon-chevron-right icon-large"></i>&nbsp;&nbsp;<span style="color:red">PENDIENTE</span></h3>
        <p>Carlos Calvo 999, <a href="">Ciudad Autónoma de Buenos Aires</a>, <a href="">Buenos Aires</a></p>       
      </div>
      ...
      <div class="row">
	      ...
	      <div id="btnGroupActions" class="btn-group" data-toggle="buttons-checkbox">
	 	  ...
	 	  <div id="btnGroupSocial" class="btn-group">
			...
			<div class="btn-group" style="float:right;">
				<button class="btn btn-primary"><i class="icon-edit icon-large"></i>&nbsp;&nbsp;&nbsp;Editar</button>			
			</div>
	  ...
	  <div class="row-fluid">
	 	...
	 	<div class="span8">  	 	
	 				<table id="tblIssueInfo" class="table table-hover">			        					
						 <tr>
						    <th>ID:</th>
						    <td>567464</td>						  
						 </tr>
						 ...
						 <tr>
						  ...
						  <tr>
						    ...
						    <td>
						    <div class="issueDesc">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ac justo nibh. 
					        Nullam odio tortor, consequat eget lacus non, varius iaculis massa. Nullam consequat, eros a faucibus egestas, 
					        nunc tortor convallis diam, at dapibus tortor tortor in metus. 
					        Sed ullamcorper quis magna a ullamcorper. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. 
					        Donec vitae tempor felis, sit amet ornare ligula. Duis porttitor volutpat condimentum. 
					        Ut tincidunt adipiscing ligula. Nunc vitae bibendum ligula. Etiam et arcu congue, elementum nisi a, porttitor est. 
					        Phasellus commodo tortor eu diam scelerisque, nec vehicula orci interdum. Nulla facilisi. Sed at ligula mi. Mauris et augue sem.							
							</div>
							</td>						   
						 </tr>
						 <tr>
						  ...
						  <tr>
						    <th>Etiquetas:</th>
						    <td>
						    	<span class="label label-info">bache</span>
						    	<span class="label label-info">asfalto roto</span>
						    	<span class="label label-info">pozo</span>						    	
						    </td>						   
						 </tr>
					</table>	 	
	 	</div>
...
<!-- 			        <h4><i class="icon-reorder icon-large"></i>&nbsp;&nbsp;DESCRIPCIÓN</h4> -->
<!-- 			      </a> -->
<!-- 			    </div> -->
			  ...
			  <div class="accordion-group">
			    <div class="accordion-heading">
			      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
			        <h4><i class="icon-wrench icon-large"></i>&nbsp;&nbsp;LICITACIÓN</h4>
			      </a>
			    </div>
			      ...
			      <div class="accordion-inner">
			       <div class="span8">  
				       <table class="table table-hover table-bordered">
				       		<tr>
							    <td>Obra:</td>
							    <td>Reparación de calzada en Carlos Calvo 999</td>						  
						 	</tr>
						 	<tr>
							    <td>Expediente N°:</td>
							    <td>4402-D-13</td>						  
			  ...
			  <div class="accordion-group">
			    <div class="accordion-heading">
			      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
			       <h4><i class="icon-time icon-large"></i>&nbsp;&nbsp;HISTORIAL DE REVISIONES</h4>
			      </a>
			    </div>
			      ...
			      <div class="accordion-inner">
			        <table class="table table-hover table-bordered">
			        	<thead>			        
						 ...
						 <tr>
						    <td>25/04/13 17:05</td>
						    <td>perezq</td>
						    <td>Modificación</td>
						    <td>Abierto</td>
						    <td>Se adjuntan archivos.</td>
						 </tr>
						 <tr>
						    <td>21/04/13 11:32</td>
						    <td>ramosj</td>
						    <td>Alta</td>
						    <td>Abierto</td>
						    <td>Se publicó un nuevo reclamo.</td>
						 </tr>
					</table>
			      </div>
			    </div>
			  ...
			  <div class="accordion-group">
			    <div class="accordion-heading">
			      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFour">
			        <h4><i class="icon-map-marker icon-large"></i>&nbsp;&nbsp;RECLAMOS SIMILARES</h4>
			      </a>
			    </div>
			  ...
			  <div class="accordion-group">
			    <div class="accordion-heading">
			      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFive">
			       <h4><i class="icon-camera icon-large"></i>&nbsp;&nbsp;IMÁGENES Y VIDEOS</h4>			   
			      </a>
			    </div>
			  ...
			  <div class="accordion-group">
			    <div class="accordion-heading ">
			      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseSix">
			       <h4><i class="icon-comments icon-large"></i>&nbsp;&nbsp;COMENTARIOS</h4>
			      </a>
			    </div>
...
<!-- 			    </div> -->
		...
		<!--Sidebar content-->
    	   ...
    	   <ul class="thumbnails">
	  	   		<li  style="margin-left:0">
	    			<a href="#" class="thumbnail">
	      				<img src="${pageContext.request.contextPath}/resources/images/mapmarker2.png" alt="">	    
	    			</a>  		
	  			</li>	
		   </ul>
