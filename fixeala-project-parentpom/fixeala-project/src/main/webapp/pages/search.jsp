...
<script type="text/javascript">
    	...
    	$( document ).ready(function() {
    		...
    		for(var i = 0; i < allTags.length ; i++){
    			$(".tagCloud").append( "<a class=\"tagLinkCloud\" href=\"" +allTags[i].url+ "\"><span style=\"padding: 10px; margin: 0 15px 30px 0;  font-size: 16px;\" class=\"label label-default\">" +allTags[i].label+ "</span></a>");
    		}
    		
    		for(var i = 0; i < allStatus.length ; i++){
    			$(".statusCloud").append( "<a class=\"statusLinkCloud\" href=\"" +allStatus[i].url+ "\"><span style=\"padding: 10px; margin: 0 15px 30px 0;  font-size: 16px;\" class=\""+allStatus[i].css+"\">" +allStatus[i].text+ "</span></a>");
    		}
    	});
