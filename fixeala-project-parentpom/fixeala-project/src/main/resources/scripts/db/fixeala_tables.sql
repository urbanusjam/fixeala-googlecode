...
CREATE TABLE ISSUE_LICITACION ( 	  
	   ID_ISSUE_LICITACION BIGINT(20) NOT NULL,
	--   ID_ISSUE BIGINT(20) NOT NULL, 
	   ...
	   EMPRESA_CONSTRUCTORA VARCHAR (255) NULL,
...
CREATE TABLE ISSUE (
	   ID_ISSUE BIGINT(20) NOT NULL, 
	   USERNAME VARCHAR(50) NOT NULL,
	   ID_ISSUE_LICITACION BIGINT(20) NULL, 
	   ...
	   FOREIGN KEY (USERNAME) REFERENCES USER (USERNAME),
	   FOREIGN KEY (ID_ISSUE_LICITACION) REFERENCES ISSUE_LICITACION (ID_ISSUE_LICITACION)
