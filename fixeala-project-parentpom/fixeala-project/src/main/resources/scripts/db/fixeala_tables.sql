...
VALUES ('Ministerio de Ambiente y Espacio Pœblico','MAYEPGC', 'Buenos Aires', 'BA', 'Ciudad de Buenos Aires', 'CABA');
...
VALUES
('coripel','c7589745dd1841655ac79a8f6fbb8e63b01b1e00','coripel@gmail.com','Cora','Reyes Calens',NULL, 1, 'Responsable de çrea', NULL, NULL, NULL,NULL,NULL,NULL,NULL,1,1),
('fakeuser','43a3f7f06dc85a1d3249e073c2fe3fa2cfe06cc5','fakeuser@gmail.com','Juan','V‡squez',NULL, 2, 'Asistente', 'S. S. de Higiene Urbana', 'SSHU', NULL,NULL,NULL,NULL,NULL,1,1),
('helloworld','b6fc2132f07b0230ac197d342548c10b1c760ccf','helloworld@gmail.com',NULL,NULL, NULL, NULL, NULL, NULL, NULL, 'San Telmo',NULL,NULL,NULL,NULL,0,1),
('mock','e8a26afff685de0b2e2ae72a6fbb3747a0ed5fe2','mock@gmail.com',NULL,NULL, NULL, NULL, NULL, NULL, NULL, 'San Telmo',NULL,NULL,NULL,NULL,0,1);

INSERT INTO `authority` (`USERNAME`,`AUTHORITY`) 
VALUES ('coripel','ROLE_ADMIN'),('fakeuser','ROLE_MANAGER'),('helloworld','ROLE_USER'),('mock','ROLE_USER');
